...
public class SignUp extends AppCompatActivity {
    ...
    public void callNextSignupScreen(View view) {
        ...
        HashMap<String, Object> _userData = new HashMap<>();
        _userData.put("fullName", Objects.requireNonNull(fullName.getEditText()).getText().toString().trim());
        _userData.put("email", Objects.requireNonNull(email.getEditText()).getText().toString().trim());
        _userData.put("username", Objects.requireNonNull(username.getEditText()).getText().toString().trim());
        _userData.put("password", Objects.requireNonNull(password.getEditText()).getText().toString().trim());
