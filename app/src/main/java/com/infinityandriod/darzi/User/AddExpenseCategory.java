...
public class AddExpenseCategory extends AppCompatActivity {
    ...
    private static final String TAG = "Add Expense Category";
    ImageView backBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Back button hooks
        backBtn = findViewById(R.id.add_expense_category_back_button);
        backBtn.setOnClickListener(view -> {
            AddExpenseCategory.super.onBackPressed();
            finish();
        });

        // Data hook
        category = findViewById(R.id.add_expense_category_name);
    }
